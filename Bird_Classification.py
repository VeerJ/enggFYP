...
def run():
    ...
    st.markdown('''<h4 style='text-align: center; color: #d73b5c;'>* Data is based "270 Bird Species"</h4>''',
                unsafe_allow_html=True)

    img_file = st.file_uploader("Pick an image to be predicted", type=["jpg", "png"])
